              ...
              <ul class="list-unstyled inner-level-menu">
                <li>
                  <a href="Pages.Auth.Login.html">
                    <i class="simple-icon-user-following"></i> <span class="d-inline-block">ورود</span>
                  </a>
                </li>
                <li>
                  <a href="Pages.Auth.Register.html">
                    <i class="simple-icon-user-follow"></i> <span class="d-inline-block">عضویت</span>
                  </a>
                </li>
                <li>
              ...
              <ul class="list-unstyled inner-level-menu">
                ...
                <li>
                  <a href="Pages.Misc.Error.html">
                    <i class="simple-icon-exclamation"></i> <span class="d-inline-block">صفحه خطا</span>
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="Pages.Misc.Mailing.html">
                    <i class="simple-icon-envelope-open"></i> <span class="d-inline-block">ایمیل</span>
                  </a>
                </li>
                <li>
              ...
              <ul class="list-unstyled inner-level-menu">
                ...
                <li>
                  <a href="Ui.Forms.Wizard.html">
                    <i class="simple-icon-magic-wand"></i> <span class="d-inline-block">ویزارد</span>
                  </a>
                </li>
              </ul>
            </div>
              ...
              <ul class="list-unstyled inner-level-menu">
                ...
                <li>
                  <a href="Ui.Datatables.Pagination.html">
                    <i class="simple-icon-notebook"></i> <span class="d-inline-block">صفحه بندی</span>
                  </a>
                </li>
                <li>
              ...
              <ul class="list-unstyled inner-level-menu">
                ...
                <li>
                  <a href="Ui.Components.Buttons.html">
                    <i class="simple-icon-control-play"></i> <span class="d-inline-block">دکمه ها</span>
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="Ui.Components.Dropdowns.html">
                    <i class="simple-icon-arrow-down"></i> <span class="d-inline-block">بازشونده ها - Dropdowns</span>
                  </a>
                </li>
                <li>
                  <a href="Ui.Components.Editors.html">
                    <i class="simple-icon-book-open"></i> <span class="d-inline-block">ویرایشگر متن</span>
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="Ui.Components.Navigation.html">
                    <i class="simple-icon-cursor"></i> <span class="d-inline-block">منو و ناوبری</span>
                  </a>
                </li>
              ...
              <ul class="list-unstyled inner-level-menu">
                <li>
                  <a href="Menu.Default.html">
                    <i class="simple-icon-control-pause"></i> <span class="d-inline-block">پیش فرض</span>
                  </a>
                </li>
                <li>
                  <a href="Menu.Subhidden.html">
                    <i class="simple-icon-arrow-left mi-subhidden"></i> <span class="d-inline-block">زیرمنو مخفی</span>
                  </a>
                </li>
                <li>
                  <a href="Menu.Hidden.html">
                    <i class="simple-icon-control-start mi-hidden"></i> <span class="d-inline-block">مخفی</span>
                  </a>
                </li>
                <li>
                  <a href="Menu.Mainhidden.html">
                    <i class="simple-icon-control-rewind mi-hidden"></i> <span class="d-inline-block">اصلی مخفی</span>
                  </a>
                </li>
              </ul>
            </div>
