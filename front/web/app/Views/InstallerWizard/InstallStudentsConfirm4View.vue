...
export default {
  name: "InstallStudentsConfirm4View",
  ...
  data() {
    return {
      single_url: "/install/student/edit",// will use (POST) method for edit and (DELETE) method for delete teacher
      list_url: "/install/students",
      headers: [
