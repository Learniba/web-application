...
export default {
  name: "InstallTeachersValidate2View",
  ...
  data() {
    return {
      ...
      teachers: [],
      error_list_url: "/install/teachers/errors",
      validate_url: "/install/teachers/validate/row",
      headers: [
  ...
  methods: {
    last() {
      this.$Axios.delete('/install/teachers').then((res) => {
    ...
    prepare_data() {
      let app = this;
      this.$Axios.get('/install/teachers').then((data) => {
